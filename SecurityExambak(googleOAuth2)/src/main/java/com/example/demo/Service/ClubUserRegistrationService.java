...
public class ClubUserRegistrationService {
	...
	// REQUIRES_NEW를 대체
	// 1. REQUIRED : 기존 트랜잭션 재사용
	// 2. SUPPORTS : 트랜잭션이 있으면 사용 없으면 없이 실행
	// 3. MANDATORY : 기존 트랜잭션 필수
	// 4. NOT_SUPPORTED : 트랜잭션 없이 실행.
	@Transactional(propagation = Propagation.REQUIRES_NEW)
	public ClubUser saveOrUpdateSocialMember(SocialUserInfo socialUserInfo, 
			String provider) {
